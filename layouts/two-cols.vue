<template>
  <div class="slidev-layout two-cols relative flex flex-col justify-between h-full p-10">
    <CalmecacBackground />
    ...
    <!-- Main Content -->
    <main class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 items-start overflow-y-auto relative z-10 my-auto">
